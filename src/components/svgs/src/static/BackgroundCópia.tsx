...
const SvgBackgroundCópia = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 1600 800" {...props} width="1em" height="1em">
    <path fill="#009bdb" d="M0 0h1600v800H0z" />
    <path
      fill="#47abe2"
...
export default SvgBackgroundCópia;
